...
// ===== Hướng Xuất Hành (theo Can ngày) =====
  ...
  function printStyle(today, currentLunarDate, backgroundType = 'transparent'){
    ...
    res += `
      ...
      .todayduonglich{ color:#fff; font-family:'Bebas Neue', sans-serif; text-align:center; font-size: clamp(90px, 12vw, 170px); line-height: 0.9; letter-spacing: 3px; font-weight: 900; text-shadow: 0 8px 25px rgba(0,0,0,0.15); }
