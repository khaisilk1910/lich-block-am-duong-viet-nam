...
//  }
  ...
  function getThanSat(lunarDate) {
		...
		// Lấy Chi ngày, Chi tháng
		let chiNgayTruc, chiThang;
		if (Array.isArray(canChi)) {
		  chiNgayTruc = canChi[0]?.split(" ")[1] || "";
		  chiThang    = canChi[1]?.split(" ")[1] || "";
		} else {
		  chiNgayTruc = canChi.ngay?.split(" ")[1] || "";
		  chiThang    = canChi.thang?.split(" ")[1] || "";
		}
		...
		const trucInfo  = THAP_NHI_TRUC[trucName] || { tot: "", xau: "" };
