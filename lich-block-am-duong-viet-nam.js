...
// ===== Hướng Xuất Hành (theo Can ngày) =====
  ...
  function printStyle(today, currentLunarDate, backgroundType = 'transparent'){
    ...
    res += `
      ...
      .nam_top { font-family: 'Bebas Neue', sans-serif; padding: 0 5px; color:#fff; bottom: -8px; font-size: clamp(20px, 2.0vw, 26px); font-weight:bold; text-align:center; text-shadow: 0 2px 4px rgba(0,0,0,0.28); }
