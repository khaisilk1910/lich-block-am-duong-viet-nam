...
// ===== Hướng Xuất Hành (theo Can ngày) =====
  ...
  function printStyle(today, currentLunarDate, backgroundType = 'transparent'){
    ...
    res += `
      ...
      .show_mai_tet { position: absolute; top: 0; left: 0; display: flex; text-align: center; height: 235%; width: 25%; align-items: center; justify-content: center; z-index: 100; }

      .show_dao_tet { position: absolute; top: 0; right: 0; display: flex; text-align: center; height: 235%; width: 25%; align-items: center; justify-content: center; z-index: 100; }
